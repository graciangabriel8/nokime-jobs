...
QUESTIONS = [
    ...
    {"id": "appris", "kind": "check",
     ...
     "options": [
         ...
         ("service", "Le service en salle", "Table service"),
         ("accueil", "L’accueil et la réception", "Welcoming guests and the front desk"),
         ("etages", "L’entretien des chambres", "Housekeeping"),
         ("soins", "Les soins au spa", "Spa treatments"),
